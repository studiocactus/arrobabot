...
pub fn clear(profile:&str) {for k in ["bot_token","bot_refresh","channel_token","channel_refresh","ai_key","ai_origin","client_secret","discord_webhook","bot_expires","channel_expires","obsidian_key"] {let _=set(profile,k,"");}}
